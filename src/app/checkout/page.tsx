...
import { Check, ArrowRight, Star, Zap, Lock, Copy, Check as CheckIcon, Clock, Infinity, Loader2 } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  const [coupleName, setCoupleName] = useState<string>('Sua História');
  ...
  const selectPlan = (plan: 'temporary' | 'permanent') => {
